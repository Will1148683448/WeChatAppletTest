		...
		var m = function(e, r) {
			return e.map((function(e) {
					...
					return s ? function(e, r, n) {
						...
						var i, s = h((0, t.createClass)(r.classes)),
							l = "";
						for (var m in "text" === e && r.italic > 0 && (l += "margin-right:" + r.italic + "em;"), r.style) r.style.hasOwnProperty(m) && (l += "".concat((i = m, i.replace(o, "-$1")
								.toLowerCase()), ":")
							.concat(r.style[m], ";"));
						l && (a = !0);
						var u = {};
						for (var p in r.attributes) r.attributes.hasOwnProperty(p) && (u[p] = h(r.attributes[p]));
						if ("span" === e) return {
							name: "span",
							attrs: {
								class: s + " katex-span",
		...
		"undefined" != typeof self && self, n = function() {
			return function() {
						...
						return t.extend = function(t) {
							...
							return this._fontMetrics || (this._fontMetrics = function(e) {
								...
								if (!N[t = e >= 5 ? 0 : e >= 3 ? 1 : 2]) {
									...
									for (var n in T) T.hasOwnProperty(n) && (r[n] = T[n][t])
								}
								return N[t]
				...
				var H = R,
					...
					P = function(e, t) {
						var r;
						if (e.unit in E) r = E[e.unit] / t.fontMetrics()
							.ptPerEm / t.sizeMultiplier;
						else if ("mu" === e.unit) r = t.fontMetrics()
							.cssEmPerMu;
						else {
							var a;
							if (a = t.style.isTight() ? t.havingStyle(t.style.text()) : t, "ex" === e.unit) r = a.fontMetrics()
								.xHeight;
							else {
					...
					U = function(e) {
						...
						for (var r in t.className = V(this.classes), this.style) this.style.hasOwnProperty(r) && (t.style[r] = this.style[r]);
					...
					_ = function(e) {
						var t = "<" + e;
                        var temp = l.escape(V(this.classes))
					...
					$ = function() {
						...
						return t.hasClass = function(e) {
							...
							var e = document.createTextNode(this.text),
								t = null;
							for (var r in this.italic > 0 && ((t = document.createElement("span"))
								.style.marginRight = F(this.italic)), this.classes.length > 0 && ((t = t || document.createElement("span"))
								.className = V(this.classes)), this.style) this.style.hasOwnProperty(r) && ((t = t || document.createElement("span"))
								.style[r] = this.style[r]);
				...
				var Ce = [
					...
					Ve = {
						...
						mathsym: function(e, t, r, n) {
							return void 0 === n && (n = []), "boldsymbol" === r.font && qe(e, "Main-Bold", t)
								.metrics ? Ie(e, "Main-Bold", t, r, n.concat(["mathbf"])) : "\\" === e || "main" === ne[t][e].font ? Ie(e, "Main-Regular", t, r, n) : Ie(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
						},
						makeSpan: He,
						makeSvgSpan: Ee,
						makeLineSpan: function(e, t, r) {
							var n = He([e], [], t);
							return n.height = Math.max(r || t.fontMetrics()
								.defaultRuleThickness, t.minRuleThickness), n.style.borderBottomWidth = F(n.height), n.maxFontSize = 1, n
						},
							...
							if (l) {
								...
								if ("boldsymbol" === l) {
									var d = function(e, t, r, n, a) {
										return "textord" !== a && qe(e, "Math-BoldItalic", t)
											.metrics ? {
								...
								if (qe(i, u, a)
									.metrics) return Ie(i, u, a, t, o.concat(p));
								if (de.hasOwnProperty(i) && "Typewriter" === u.substr(0, 10)) {
									for (var f = [], g = 0; g < i.length; g++) f.push(Ie(i[g], u, a, t, o.concat(p)));
									return Le(f)
								}
							}
				...
				function ut(e, t) {
					...
					s.length > 0 && o.push(mt(s, t)), r ? ((i = mt(it(r, t, !0)))
						.classes = ["tag"], o.push(i)) : n && o.push(n);
						...
						for (var a, i = [], o = 0; o < e.length; o++) {
							...
							if (s instanceof dt && a instanceof dt) {
								if ("mtext" === s.type && "mtext" === a.type && s.getAttribute("mathvariant") === a.getAttribute("mathvariant")) {
									var l;
									(l = a.children)
									.push.apply(l, s.children);
									continue
								}
								if ("mn" === s.type && "mn" === a.type) {
									var h;
									(h = a.children)
									.push.apply(h, s.children);
									continue
								}
					...
					Nt = function(e, t) {
						var r = function() {
								...
								if (l.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
									var a, i, o, s = "ordgroup" === (d = e.base)
										.type ? d.body.length : 1;
				...
				var Rt = function(e, t) {
						var r, n, a;
						e && "supsub" === e.type ? (r = (n = qt(e.base, "accent"))
								.base, e.base = r, a = function(e) {
									if (e instanceof Y) return e;
									throw new Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
								}(ct(e, t)), e.base = n) : r = (n = qt(e, "accent"))
							.base;
						var i = ct(r, t.havingCrampedStyle()),
							o = 0;
						if (n.isShifty && l.isCharacterBox(r)) {
							var s = l.getBaseElem(r);
							o = Q(ct(s, t.havingCrampedStyle()))
								.skew
						}
						var h, c = "\\c" === n.label,
							m = c ? i.height + i.depth : Math.min(i.height, t.fontMetrics()
								.xHeight);
						if (n.isStretchy) h = Nt(n, t), h = Ve.makeVList({
							...
							"\\vec" === n.label ? (u = Ve.staticSvg("vec", t), p = Ve.svgData.vec[1]) : ((u = Q(u = Ve.makeOrd({
								...
								.italic = 0, p = u.width, c && (m += u.depth)), h = Ve.makeSpan(["accent-body"], [u]);
				...
				Ze({
					...
					htmlBuilder: function(e, t) {
						...
						i.classes.push(o + "-arrow-pad"), e.below && (a = t.havingStyle(n.sub()), (r = Ve.wrapFragment(ct(e.below, a, t), t))
							.classes.push(o + "-arrow-pad"));
						var s, l = Nt(e, t),
							h = -t.fontMetrics()
							.axisHeight + .5 * l.height,
							c = -t.fontMetrics()
							.axisHeight - .5 * l.height - .111;
						if ((i.depth > .25 || "\\xleftequilibrium" === e.label) && (c -= i.depth), r) {
							var m = -t.fontMetrics()
								.axisHeight + r.height + .5 * l.height + .111;
							s = Ve.makeVList({
				...
				Ze({
					...
					mathmlBuilder: function(e, t) {
						...
						return (r = new gt.MathNode("mpadded", [r]))
							.setAttribute("width", "0"), "left" === e.side && r.setAttribute("lspace", "-1width"), r.setAttribute("voffset", "0.7em"), (r = new gt.MathNode("mstyle", [r]))
					...
					handler: function(e, t) {
						for (var r = e.parser, a = qt(t[0], "ordgroup")
							.body, i = "", o = 0; o < a.length; o++) i += qt(a[o], "textord")
							.text;
						var s, l = parseInt(i);
					...
					handler: function(e) {
						...
						for (var o, s = 0, l = [
							...
							if ("#" === (a = t.gullet.popToken())
								...
								l[s].push(a.text)
							} var h = t.gullet.consumeArg()
							.tokens;
						return o && h.unshift(o), "\\edef" !== r && "\\xdef" !== r || (h = t.gullet.expandTokens(h))
							.reverse(), t.gullet.macros.set(i, {
								tokens: h,
								numArgs: s,
								delimiters: l
							}, r === Ut[r]), {
				...
				var Xt = function(e, t, r) {
					...
					jt = function(e, t, r) {
						var n = t.havingBaseStyle(r),
							a = (1 - t.sizeMultiplier / n.sizeMultiplier) * t.fontMetrics()
							.axisHeight;
					...
					mr = function(e, t, r, n) {
						for (var a = Math.min(2, 3 - n.style.size); a < r.length && "stack" !== r[a].type; a++) {
							var i = Xt(e, cr(r[a]), "math"),
								o = i.height + i.depth;
							if ("small" === r[a].type && (o *= n.havingBaseStyle(r[a].style)
								.sizeMultiplier), o > t) return r[a]
						}
						return r[r.length - 1]
					},
					ur = function(e, t, r, n, a, i) {
						var o;
					...
					pr = {
						sqrtImage: function(e, t) {
							var r, n, a = t.havingBaseSizing(),
								...
								o = a.sizeMultiplier,
								s = Math.max(0, t.minRuleThickness - t.fontMetrics()
									.sqrtRuleThickness),
								l = 0,
								h = 0,
								c = 0;
							return "small" === i.type ? (e < 1 ? o = 1 : e < 1.4 && (o = .7), h = (1 + s) / o, (r = rr("sqrtMain", l = (1 + s + .08) / o, c = 1e3 + 1e3 * s + 80, s, t))
								.style.minWidth = "0.853em", n = .833 / o) : "large" === i.type ? (c = 1080 * or[i.size], h = (or[i.size] + s) / o, l = (or[i.size] + s + .08) / o, (r = rr("sqrtSize" + i.size, l, c, s, t))
								.style.minWidth = "1.02em", n = 1 / o) : (l = e + s + .08, h = e + s, c = Math.floor(1e3 * e + s) + 80, (r = rr("sqrtTall", l, c, s, t))
								.style.minWidth = "0.742em", n = 1.056), r.height = h, r.style.height = F(l), {
								span: r,
								advanceWidth: n,
								ruleWidth: (t.fontMetrics()
									.sqrtRuleThickness + s) * o
							}
						},
				...
				Ze({
					...
					htmlBuilder: function(e, t) {
						vr(e);
						for (var r, n, a = it(e.body, t, !0, ["mopen", "mclose"]), i = 0, o = 0, s = !1, l = 0; l < a.length; l++) a[l].isMiddle ? s = !0 : (i = Math.max(a[l].height, i), o = Math.max(a[l].depth, o));
						if (i *= t.sizeMultiplier, o *= t.sizeMultiplier, r = "." === e.left ? ht(t, ["mopen"]) : pr.leftRightDelim(e.left, i, o, t, e.mode, ["mopen"]), a.unshift(r), s)
							for (var h = 1; h < a.length; h++) {
								var c = a[h].isMiddle;
								c && (a[h] = pr.leftRightDelim(c.delim, i, o, c.options, e.mode, []))
							}
						if ("." === e.right) n = ht(t, ["mclose"]);
						else {
				...
				var yr = function(e, t) {
						var r, n, a, i = Ve.wrapFragment(ct(e.body, t), t),
							o = e.label.substr(1),
							s = t.sizeMultiplier,
							h = 0,
							c = l.isCharacterBox(e.body);
						if ("sout" === o)(r = Ve.makeSpan(["stretchy", "sout"]))
							.height = t.fontMetrics()
							.defaultRuleThickness / s, h = -.5 * t.fontMetrics()
							.xHeight;
						else if ("phase" === o) {
							var m = P({
									number: .6,
							...
							(r = Ve.makeSvgSpan(["hide-tail"], [g], t))
							.style.height = F(p), h = i.depth + m + u
						} else {
							/cancel/.test(o) ? c || i.classes.push("cancel-pad") : "angl" === o ? i.classes.push("anglpad") : i.classes.push("boxpad");
							var v = 0,
								y = 0,
								b = 0;
							/box/.test(o) ? (b = Math.max(t.fontMetrics()
									.fboxrule, t.minRuleThickness), y = v = t.fontMetrics()
								.fboxsep + ("colorbox" === o ? 0 : b)) : "angl" === o ? (v = 4 * (b = Math.max(t.fontMetrics()
								.defaultRuleThickness, t.minRuleThickness)), y = Math.max(0, .25 - i.depth)) : y = v = c ? .2 : 0, r = Bt(i, o, v, y, t), /fbox|boxed|fcolorbox/.test(o) ? (r.style.borderStyle = "solid", r.style.borderWidth = F(b)) : "angl" === o && .049 !== b && (r.style.borderTopWidth = F(b), r.style.borderRightWidth = F(b)), h = i.depth + y, e.backgroundColor && (r.style.backgroundColor = e.backgroundColor, e.borderColor && (r.style.borderColor = e.borderColor))
						}
					...
					br = function(e, t) {
						...
						switch (e.label) {
							...
							case "\\colorbox":
								if (r = t.fontMetrics()
									.fboxsep * t.fontMetrics()
									.ptPerEm, n.setAttribute("width", "+" + 2 * r + "pt"), n.setAttribute("height", "+" + 2 * r + "pt"), n.setAttribute("lspace", r + "pt"), n.setAttribute("voffset", r + "pt"), "\\fcolorbox" === e.label) {
									var a = Math.max(t.fontMetrics()
										.fboxrule, t.minRuleThickness);
				...
				function Ar(e) {
					...
					for (var r = e.fetch()
							.text;
						"\\hline" === r || "\\hdashline" === r;) e.consume(), t.push("\\hdashline" === r), e.consumeSpaces(), r = e.fetch()
						.text;
					return t
				}
				var Tr = function(e) {
				...
				function Cr(e, t, r) {
					...
					for (x(), y.push(Ar(e));;) {
						...
						if ("&" === S) {
							...
							var M = void 0;
							" " !== e.gullet.future()
								.text && (M = e.parseSizeGroup(!0)), v.push(M ? M.value : null), w(), y.push(Ar(e)), f = [], g.push(f), x()
						}
					}
				...
				var qr = function(e, t) {
						var r, a, i = e.body.length,
							...
							h = new Array(i),
							c = [],
							m = Math.max(t.fontMetrics()
								.arrayRuleWidth, t.minRuleThickness),
							u = 1 / t.fontMetrics()
							.ptPerEm,
							p = 5 * u;
						e.colSeparationType && "small" === e.colSeparationType && (p = t.havingStyle(x.SCRIPT)
							.sizeMultiplier / t.sizeMultiplier * .2778);
						...
						if (e.tags && e.tags.some((function(e) {
							...
							for (r = 0; r < i; ++r) {
								var H = h[r],
									...
									L = e.tags[r],
									D = void 0;
								(D = !0 === L ? Ve.makeSpan(["eqn-num"], [], t) : !1 === L ? Ve.makeSpan([], [], t) : Ve.makeSpan([], it(L, t, !0), t))
								.depth = H.depth, D.height = H.height, R.push({
									type: "elem",
									elem: D,
									shift: E
								})
						...
						for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
							for (var V = I[N] || {}, G = !0;
								"separator" === V.type;) {
								if (G || ((C = Ve.makeSpan(["arraycolsep"], []))
									.style.width = F(t.fontMetrics()
										.doubleRuleSep), O.push(C)), "|" !== V.separator && ":" !== V.separator) throw new n("Invalid separator type: " + V.separator);
							...
							if (!(a >= s)) {
								var X = void 0;
								(a > 0 || e.hskipBeforeAndAfter) && 0 !== (X = l.deflt(V.pregap, p)) && ((C = Ve.makeSpan(["arraycolsep"], []))
									.style.width = F(X), O.push(C));
								var W = [];
								for (r = 0; r < i; ++r) {
									var j = h[r],
										$ = j[a];
								...
								W = Ve.makeVList({
									positionType: "individualShift",
									children: W
								}, t), W = Ve.makeSpan(["col-align-" + (V.align || "c")], [W]), O.push(W), (a < s - 1 || e.hskipBeforeAndAfter) && 0 !== (X = l.deflt(V.postgap, p)) && ((C = Ve.makeSpan(["arraycolsep"], []))
									.style.width = F(X), O.push(C))
							}
						}
					...
					Or = function(e, t) {
						for (var r = [], n = new gt.MathNode("mtd", [], ["mtr-glue"]), a = new gt.MathNode("mtd", [], ["mml-eqn-num"]), i = 0; i < e.body.length; i++) {
							for (var o = e.body[i], s = [], l = 0; l < o.length; l++) s.push(new gt.MathNode("mtd", [kt(o[l], t)]));
						...
						if (e.cols && e.cols.length > 0) {
							...
							for (var y = g; y < v; y++) "align" === p[y].type ? (u += Ir[p[y].align], f && (d += "none "), f = !0) : "separator" === p[y].type && f && (d += "|" === p[y].separator ? "solid " : "dashed ", f = !1);
						...
						return /[sd]/.test(k) && h.setAttribute("rowlines", k.trim()), "" !== m && (h = new gt.MathNode("menclose", [h]))
							.setAttribute("notation", m.trim()), e.arraystretch && e.arraystretch < 1 && (h = new gt.MathNode("mstyle", [h]))
							.setAttribute("scriptlevel", "1"), h
					},
					Rr = function(e, t) {
						...
						if (t[0] && "ordgroup" === t[0].type) {
							for (var c = "", m = 0; m < t[0].body.length; m++) c += qt(t[0].body[m], "textord")
								.text;
							r = Number(c), l = 2 * r
						}
						var u = !l;
				...
				wr({
					...
					handler: function(e, t) {
						var r = (Ot(t[0]) ? [t[0]] : qt(t[0], "ordgroup")
								.body)
							.map((function(e) {
								var t = It(e)
									.text;
					...
					handler: function(e) {
						...
						if ("*" === e.envName.charAt(e.envName.length - 1)) {
							var i = e.parser;
							if (i.consumeSpaces(), "[" === i.fetch()
								.text) {
								if (i.consume(), i.consumeSpaces(), r = i.fetch()
									.text, -1 === "lcr".indexOf(r)) throw new n("Expected l or c or r", i.nextToken);
					...
					handler: function(e, t) {
						...
						if ((a = Cr(e.parser, a, "script"))
							.body.length > 0 && a.body[0].length > 1) throw new n("{subarray} can contain only one column");
						return a
					},
					htmlBuilder: qr,
					mathmlBuilder: Or
						...
						return Tr(e),
							function(e) {
								...
								return e.gullet.endGroup(), e.gullet.endGroup(), {
									...
									hLinesBeforeRow: new Array(s.length + 1)
										.fill([])
								}
							}(e.parser)
					},
				...
				Ze({
					...
					handler: function(e, t) {
						...
						for (var o = "", s = 0; s < i.body.length; ++s) o += qt(i.body[s], "textord")
							.text;
						if ("\\begin" === a) {
				...
				function Dr(e, t) {
					...
					return "minner" === e.mclass ? r = new gt.MathNode("mpadded", n) : "mord" === e.mclass ? e.isCharacterBox ? (r = n[0])
						.type = "mi" : r = new gt.MathNode("mi", n) : (e.isCharacterBox ? (r = n[0])
							.type = "mo" : r = new gt.MathNode("mo", n), "mbin" === e.mclass ? (r.attributes.lspace = "0.22em", r.attributes.rspace = "0.22em") : "mpunct" === e.mclass ? (r.attributes.lspace = "0em", r.attributes.rspace = "0.17em") : "mopen" === e.mclass || "mclose" === e.mclass ? (r.attributes.lspace = "0em", r.attributes.rspace = "0em") : "minner" === e.mclass && (r.attributes.lspace = "0.0556em", r.attributes.width = "+0.1111em")), r
				}
				Ze({
					type: "mclass",
				...
				var Ur = function(e, t) {
					...
					_r = function(e, t) {
						...
						r = t.havingStyle(i);
						var h, c, m, u, p, d, f, g, v, y, b = ct(e.denom, r, t);
						if (e.hasBarLine ? (e.barSize ? (c = P(e.barSize, t), h = Ve.makeLineSpan("frac-line", t, c)) : h = Ve.makeLineSpan("frac-line", t), c = h.height, m = h.height) : (h = null, c = 0, m = t.fontMetrics()
							.defaultRuleThickness), n.size === x.DISPLAY.size || "display" === e.size ? (u = t.fontMetrics()
							.num1, p = c > 0 ? 3 * m : 7 * m, d = t.fontMetrics()
							.denom1) : (c > 0 ? (u = t.fontMetrics()
								.num2, p = m) : (u = t.fontMetrics()
								.num3, p = 3 * m), d = t.fontMetrics()
							.denom2), h) {
							var w = t.fontMetrics()
								.axisHeight;
						...
						return r = t.havingStyle(n), f.height *= r.sizeMultiplier / t.sizeMultiplier, f.depth *= r.sizeMultiplier / t.sizeMultiplier, g = n.size === x.DISPLAY.size ? t.fontMetrics()
							.delim1 : n.size === x.SCRIPTSCRIPT.size ? t.havingStyle(x.SCRIPT)
							.fontMetrics()
							.delim2 : t.fontMetrics()
							.delim2, v = null == e.leftDelim ? ht(t, ["mopen"]) : pr.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(n), e.mode, ["mopen"]), y = e.continued ? Ve.makeSpan([]) : null == e.rightDelim ? ht(t, ["mclose"]) : pr.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(n), e.mode, ["mclose"]), Ve.makeSpan(["mord"].concat(r.sizingClasses(t)), [v, Ve.makeSpan(["mfrac"], [f]), y], t)
					},
					Yr = function(e, t) {
				...
				var jr = function(e, t) {
					...
					var i, o = ct(n.base, t.havingBaseStyle(x.DISPLAY)),
						s = Nt(n, t);
					if (n.isOver ? (i = Ve.makeVList({
						...
						.children[0].children[0].children[1].classes.push("svg-align") : (i = Ve.makeVList({
							positionType: "bottom",
						...
						.children[0].children[0].children[0].classes.push("svg-align"), r) {
				...
				Ze({
					...
					htmlBuilder: function(e, t) {
						var r = it(e.body, t, !1),
							n = ["enclosing"];
						e.attributes.class && n.push.apply(n, e.attributes.class.trim()
							.split(/\s+/));
				...
				Ze({
					...
					handler: function(e, t, r) {
						var a = e.parser,
							...
							l = "";
						if (r[0])
							for (var h = qt(r[0], "raw")
								.string.split(","), c = 0; c < h.length; c++) {
								var m = h[c].split("=");
								if (2 === m.length) {
									var u = m[1].trim();
									switch (m[0].trim()) {
						...
						return "" === l && (l = (l = (l = p)
								.replace(/^.*[\\/]/, ""))
							.substring(0, l.lastIndexOf("."))), a.settings.isTrusted({
				...
				var Kr = function(e, t, r, n, a, i, o) {
						...
						if (t) {
							...
							h = {
								elem: u,
								kern: Math.max(n.fontMetrics()
									.bigOpSpacing1, n.fontMetrics()
									.bigOpSpacing3 - u.depth)
							}
						}
						if (r) {
							...
							s = {
								elem: p,
								kern: Math.max(n.fontMetrics()
									.bigOpSpacing2, n.fontMetrics()
									.bigOpSpacing4 - p.height)
							}
						}
						if (h && s) {
							var d = n.fontMetrics()
								.bigOpSpacing5 + s.elem.height + s.elem.depth + s.kern + e.depth + o;
							c = Ve.makeVList({
								positionType: "bottom",
								positionData: d,
								children: [{
					...
					Qr = function(e, t) {
						...
						if (s.size === x.DISPLAY.size && a.symbol && !l.contains(Jr, a.name) && (h = !0), a.symbol) {
							...
							var d = it(a.body, t, !0);
							1 === d.length && d[0] instanceof $ ? (o = d[0])
								.classes[0] = "mop" : o = Ve.makeSpan(["mop"], d, t)
						} else {
							for (var f = [], g = 1; g < a.name.length; g++) f.push(Ve.mathsym(a.name[g], a.mode, t));
							o = Ve.makeSpan(["mop"], f, t)
						}
						var v = 0,
							y = 0;
						return (o instanceof $ || "\\oiint" === a.name || "\\oiiint" === a.name) && !a.suppressBaseShift && (v = (o.height - o.depth) / 2 - t.fontMetrics()
							.axisHeight, y = o.italic), i ? Kr(o, r, n, t, s, y, v) : (v && (o.style.position = "relative", o.style.top = F(v)), o)
					},
					en = function(e, t) {
						var r;
						if (e.symbol) r = new dt("mo", [vt(e.name, e.mode)]), l.contains(Jr, e.name) && r.setAttribute("largeop", "false");
						else if (e.body) r = new dt("mo", xt(e.body, t));
						else {
				...
				var nn = function(e, t) {
					...
					if ("supsub" === e.type ? (r = e.sup, n = e.sub, a = qt(e.base, "operatorname"), o = !0) : a = qt(e, "operatorname"), a.body.length > 0) {
						for (var s = a.body.map((function(e) {
							...
							var c = l[h];
							c instanceof $ && (c.text = c.text.replace(/\u2212/, "-")
								.replace(/\u2217/, "*"))
						}
				...
				Ze({
					...
					mathmlBuilder: function(e, t) {
						for (var r = xt(e.body, t.withFont("mathrm")), n = !0, a = 0; a < r.length; a++) {
							var i = r[a];
							if (i instanceof gt.SpaceNode);
							else if (i instanceof gt.MathNode) switch (i.type) {
								case "mi":
								case "mn":
								case "ms":
								case "mspace":
								...
								case "mo":
									var o = i.children[0];
									1 === i.children.length && o instanceof gt.TextNode ? o.text = o.text.replace(/\u2212/, "-")
										.replace(/\u2217/, "*") : n = !1;
									break;
								default:
									n = !1
				...
				Ze({
					...
					htmlBuilder: function(e, t) {
						var r = ct(e.body, t.havingCrampedStyle());
						0 === r.height && (r.height = t.fontMetrics()
							.xHeight), r = Ve.wrapFragment(r, t);
						var n = t.fontMetrics()
							.defaultRuleThickness,
							a = n;
						t.style.id < x.TEXT.id && (a = t.fontMetrics()
							.xHeight);
						var i = n + a / 4,
				...
				Ke({
					...
					htmlBuilder: function(e, t) {
						...
						if (s) {
							...
							n = ct(s, f, t), d || (u = c.height - f.fontMetrics()
								.supDrop * f.sizeMultiplier / t.sizeMultiplier)
						}
						if (h) {
							var g = t.havingStyle(t.style.sub());
							a = ct(h, g, t), d || (p = c.depth + g.fontMetrics()
								.subDrop * g.sizeMultiplier / t.sizeMultiplier)
						}
						i = t.style === x.DISPLAY ? m.sup1 : t.style.cramped ? m.sup3 : m.sup2;
						var v, y = t.sizeMultiplier,
							b = F(.5 / m.ptPerEm / y),
							w = null;
						if (a) {
					...
					mathmlBuilder: function(e, t) {
						...
						var a, i = [kt(e.base, t)];
						if (e.sub && i.push(kt(e.sub, t)), e.sup && i.push(kt(e.sup, t)), n) a = r ? "mover" : "munder";
						else if (e.sub)
							if (e.sup) {
								var o = e.base;
				...
				Sr("\\char", (function(e) {
					...
					if (t) {
						...
						for (var i; null != (i = Sn[e.future()
							.text]) && i < t;) a *= t, a += i, e.popToken()
					}
					return "\\@char{" + a + "}"
				}));
				...
				Sr("\\newcommand", (function(e) {
					...
					var t = e.consumeArgs(1)[0];
					return console.error(t.reverse()
						.map((function(e) {
							return e.text
						}))
						.join("")), ""
				...
				var Cn = {
					...
					Nn = function() {
						...
						return t.feed = function(e) {
							...
							var t, r, n;
							if (e) {
								if (this.consumeSpaces(), "[" !== this.future()
									.text) return null;
								t = this.popToken();
							...
							for (var o = [], s = 0; s < e; s++) o.push(this.consumeArg(t && t[s + 1])
								.tokens);
							return o
								...
								for (var s = (i = i.slice())
									...
									if ("#" === l.text) {
										...
										if ("#" === (l = i[--s])
											...
											var h;
											(h = i)
											.splice.apply(h, [s, 2].concat(o[+l.text - 1]))
										}
									}
								}
							...
							if ("string" == typeof n) {
								...
								for (var o = new xn(n, this.settings), s = [], l = o.lex();
					...
					Hn = function() {
						...
						return t.expect = function(e, t) {
							if (void 0 === t && (t = !0), this.fetch()
								.text !== e) throw new n("Expected '" + e + "', got '" + this.fetch()
								.text + "'", this.fetch());
							t && this.consume()
						}, t.consume = function() {
							this.nextToken = null
							...
							for (;;) {
								...
								if ("\\limits" === o.text || "\\nolimits" === o.text) {
									...
									for (this.consume();
										"'" === this.fetch()
										.text;) h.push(l), this.consume();
									"^" === this.fetch()
										.text && h.push(this.handleSupSubscript("superscript")), r = {
											type: "ordgroup",
											mode: this.mode,
											body: h
										}
							...
							var t, r = !1;
							if (this.gullet.consumeSpaces(), !(t = e || "{" === this.gullet.future()
								.text ? this.parseStringGroup("size", e) : this.parseRegexGroup(/^[-+]? *(?:$|\d+|\d+\.\d*|\.\d*) *[a-z]{0,2} *$/, "size"))) return null;
